...
CREATE MATERIALIZED VIEW Arrecadacao
AS 	SELECT L.numero, L.descricao, V.data_entrada AS data_viagem, COUNT(V.id_viagem) AS passageiros, SUM(V.tarifa) AS receita
	FROM Linha L 
	JOIN Viagem V
