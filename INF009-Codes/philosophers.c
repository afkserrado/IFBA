...
void take_forks(int i) {
    ...
    printf("Change of state: philosopher %d is now HUNGRY\n", i);
...
void put_forks(int i) {
    ...
    printf("Change of state: philosopher %d is now THINKING\n", i);
...
void test(int i) {
    if(state[i] == HUNGRY && state[LEFT(i)] != EATING && state[RIGHT(i)] != EATING) {
        ...
        printf("Change of state: philosopher %d is now EATING\n", i);
