...
public class LivroController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Conflito de regra de negócio (ex: ISBN já cadastrado)", content = @Content)
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "409", description = "Conflito de regra de negócio (ex: ISBN duplicado ou estoque incompatível)", content = @Content)
    })
    ...
    @DeleteMapping("/{id}")
    @Operation(summary = "Remove um livro do acervo", description = "Deleta o registro de um livro de forma permanente utilizando o ID informado.")
    @ApiResponses(value = {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Livro não localizado", content = @Content),
            @ApiResponse(responseCode = "409", description = "Estoque insuficiente para realizar o empréstimo", content = @Content)
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "Livro não localizado", content = @Content),
            @ApiResponse(responseCode = "409", description = "A quantidade disponível não pode ultrapassar o estoque total", content = @Content)
    })
