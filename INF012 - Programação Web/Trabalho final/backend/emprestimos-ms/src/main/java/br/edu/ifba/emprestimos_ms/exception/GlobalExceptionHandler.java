...
import br.edu.ifba.emprestimos_ms.dto.ErroResponseDTO;
import br.edu.ifba.emprestimos_ms.dto.ErroValidationDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErroResponseDTO> emprestimoNaoEncontrado(
    ...
    @ExceptionHandler({OperacaoNaoPermitidaException.class, IllegalStateException.class, IllegalArgumentException.class})
