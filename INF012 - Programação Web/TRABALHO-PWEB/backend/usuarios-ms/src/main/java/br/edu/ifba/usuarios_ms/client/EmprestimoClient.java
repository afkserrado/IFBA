...
public interface EmprestimoClient {
    ...
    // GET síncrono para http://localhost:8083/api/v1/emprestimos/validar-exclusao/usuario/{id}/ativos
    ...
    // GET síncrono para http://localhost:8083/api/v1/emprestimos/validar-exclusao/usuario/{id}/multas
